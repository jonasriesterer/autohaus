...
def send_mail(autohaus_dto: AutohausDTO) -> None:
    """Funktion, um eine E-Mail zu senden.

    :param autohaus_dto: Autohaus-Daten
    """
    ...
    # Body und Subject
    msg: Final = MIMEText(f"Neuer Autohaus: <b>{autohaus_dto.name}</b>")
    msg["Subject"] = f"Neuer Autohaus: ID={autohaus_dto.id}"
